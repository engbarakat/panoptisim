...
if __name__ == '__main__':
    ...
    pl.ylim(0, 101)
    pl.ylabel('Link Utilization')
    pl.xlabel('Number of Switches')
    pl.title("Max Link Utilization for Various Strategies")
